...
export default function RegistrationApprovalPage() {
  ...
  const [alumniRegistrations, setAlumniRegistrations] = useState<Array<AlumniRegistration>>();
  ...
  return (
    <div className="w-[98%] sm:w-[95%] max-w-5xl mx-auto my-6">
      <div className="mb-4 bg-white shadow-sm rounded-lg border p-2 pl-4">
        <h1 className="text-xl sm:text-2xl font-semibold text-mingdao-blue-dark my-auto">註冊申請驗證審核 - 企業註冊</h1>
      </div>
      ...
      <div className="mb-4 bg-white shadow-sm rounded-lg border p-2 pl-4 mt-8">
        <h1 className="text-xl sm:text-2xl font-semibold text-mingdao-blue-dark my-auto">註冊申請驗證審核 - 校友註冊</h1>
      </div>
