...
export default function CompanyProfilePage() {
  ...
  if (isLoading || !companyData || !newCompanyData) return (<></>);
                    ...
                    <div className="flex items-center px-3 py-2 border border-gray-300 rounded-md">
                      <div className="flex items-center my-auto">
                        ...
                        <span className="text-sm text-gray-600 ml-2">
                          目前狀態: <span className={companyData.published ? "text-green-500" : "text-red-500"}>{companyData.published ? "已發布" : "未發布"}</span>
                        </span>
                      </div>
                    </div>
                  </div>
