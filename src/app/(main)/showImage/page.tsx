...
export default function ShowImagePage() {
  ...
  const getTruncatedFileName = (
    ...
    return <div className="truncate max-w-full">{fileName}</div>;
  };
    ...
    <div className="h-[calc(100dvh-15rem)] bg-gray-100 py-8 overflow-auto">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex items-center justify-between mb-6">
          <h1 className="text-xl sm:text-2xl font-semibold text-mingdao-blue-dark">
            {imageTitle}
          </h1>
          <button
        ...
        <div className="bg-white shadow-sm rounded-lg border p-4">
          {isLoading ? (
            <div className="flex justify-center items-center h-96">
              <div className="animate-spin rounded-full h-16 w-16 border-t-2 border-b-2 border-mingdao-blue" />
            </div>
          ) : error ? (
            <div className="flex justify-center items-center h-96">
