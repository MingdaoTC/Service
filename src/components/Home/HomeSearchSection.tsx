    ...
    <>
        ...
        <div className="relative px-4 py-16 md:py-20 w-full max-w-6xl mx-auto">
          ...
          <div className="text-center mb-10 md:mb-12">
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 leading-tight">
              找到屬於您的<span className="text-yellow-300">理想職位</span>
            </h1>
      ...
      <div className="w-full bg-white">
        <div className="w-full max-w-6xl mx-auto -mt-8 px-4">
          <div className="bg-white rounded-xl shadow-lg py-6 px-2 md:px-8">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="col-span-2 md:col-span-1 p-3">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <Link
                    href="/categories"
                    className="flex items-center px-3 py-2 rounded-lg text-sm font-medium bg-gray-50 text-gray-700 hover:bg-gray-100 transition-colors shadow-sm"
                  >
              ...
              <div className="col-span-2 md:col-span-1 p-3">
                ...
                <div className="mt-4 bg-mingdao-blue bg-opacity-5 rounded-lg p-3">
                  <Link
